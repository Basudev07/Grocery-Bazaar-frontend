...
function Footer() {
  return (
    <footer className="bg-white mt-6 border-t border-gray-100">
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
              ...
              <li key={social.name}>
                ...
                >
                  ...
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule={social.name === 'Facebook' || social.name === 'Instagram' ? 'evenodd' : undefined} d={social.icon} clipRule={social.name === 'Facebook' || social.name === 'Instagram' ? 'evenodd' : undefined} />
                  </svg>
                </a>
              </li>
            ))}
        ...
        {/* Links Section */}
        <div className="grid grid-cols-2 gap-6 pt-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Shop</h3>
            <ul className="mt-4 space-y-3 text-sm text-gray-700">
              <li><a href="#" className="hover:text-green-600 transition">Fresh Produce</a></li>
              <li><a href="#" className="hover:text-green-600 transition">Essestials</a></li>
              <li><a href="#" className="hover:text-green-600 transition">Dairy & Eggs</a></li>
              <li><a href="#" className="hover:text-green-600 transition">Beverages</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-700">
            <li><a href="http://localhost:1337" className="hover:text-green-600 transition">Admin Login</a></li>
              <li><a href="#" className="hover:text-green-600 transition">Our Story</a></li>
              <li><a href="#" className="hover:text-green-600 transition">Sustainability</a></li>
              <li><a href="#" className="hover:text-green-600 transition">Locations</a></li>
            </ul>
          </div>
        ...
        <p className="mt-8 text-xs text-gray-500 text-center">
          © {new Date().getFullYear()} Grocery Bazaar. All rights reserved.
        </p>
      </div>
    </footer>
  );
